// extractionUtils.js - Utility functions for web scraping
...
export function executeJavaScriptSelector(jsExpression) {
    try {
...
export function querySelectorShadowDOM(rootElement, selector) {
    const elements = [];
...
export function executeJavaScriptShadowSelector(rootElement, selector) {
    try {
...
export function querySelectorAllDeep(rootElement, selector) {
    const elements = [];
...
export function findBestSelectorInContext(container, selectors) {
...
export function getPriceElementsWithBestSelector(container, selectors) {
...
export function cleanPriceText(text, attribute) {
    if (!text) return '';
...
export function extractTitleInfo(container, titleSelectors, titleAttributes) {
...
export function extractImageInfo(container, imageSelectors, imageAttributes) {
...
export function extractLinkInfo(container, linkSelectors) {
...
export function extractVideoInfo(container, videoSelectors, videoAttributes) {
...
export function extractPriceInfo(container, priceSelectors, priceAttributes) {
    const priceInfo = [];
